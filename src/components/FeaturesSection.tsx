...
import { ScanSearch, FileText, ShieldCheck, AlertTriangle, BarChart3, Bell } from "lucide-react";
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
          {features.map((feature, i) => (
            <motion.div
              ...
              className="group bg-card rounded-2xl p-6 border border-border shadow-card hover:shadow-elevated transition-all duration-300 hover:-translate-y-1"
            >
